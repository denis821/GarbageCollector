...
gdjs.ScoreCode.GDRatingTextObjects1= [];
gdjs.ScoreCode.GDRatingTextObjects2= [];
gdjs.ScoreCode.GDRatingTextObjects3= [];
...
gdjs.ScoreCode.condition0IsTrue_0.val = false;
{
gdjs.ScoreCode.condition0IsTrue_0.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1)) < 10;
}if (gdjs.ScoreCode.condition0IsTrue_0.val) {
}
...
gdjs.ScoreCode.condition1IsTrue_1.val = false;
{
gdjs.ScoreCode.condition0IsTrue_1.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1)) >= 10;
}if ( gdjs.ScoreCode.condition0IsTrue_1.val ) {
{
gdjs.ScoreCode.condition1IsTrue_1.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1)) < 20;
}}
...
gdjs.ScoreCode.condition1IsTrue_1.val = false;
{
gdjs.ScoreCode.condition0IsTrue_1.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1)) >= 20;
}if ( gdjs.ScoreCode.condition0IsTrue_1.val ) {
{
gdjs.ScoreCode.condition1IsTrue_1.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1)) < 30;
}}
gdjs.ScoreCode.conditionTrue_1.val = true && gdjs.ScoreCode.condition0IsTrue_1.val && gdjs.ScoreCode.condition1IsTrue_1.val;
}
}if (gdjs.ScoreCode.condition0IsTrue_0.val) {
...
{
gdjs.ScoreCode.condition1IsTrue_1.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1)) < 50;
}}
gdjs.ScoreCode.conditionTrue_1.val = true && gdjs.ScoreCode.condition0IsTrue_1.val && gdjs.ScoreCode.condition1IsTrue_1.val;
}
}if (gdjs.ScoreCode.condition0IsTrue_0.val) {
...
gdjs.ScoreCode.condition0IsTrue_0.val = false;
{
gdjs.ScoreCode.condition0IsTrue_0.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1)) > 50;
}if (gdjs.ScoreCode.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("AchivmentTextView"), gdjs.ScoreCode.GDAchivmentTextViewObjects1);
gdjs.copyArray(runtimeScene.getObjects("ViewAchivment"), gdjs.ScoreCode.GDViewAchivmentObjects1);
{for(var i = 0, len = gdjs.ScoreCode.GDViewAchivmentObjects1.length ;i < len;++i) {
    gdjs.ScoreCode.GDViewAchivmentObjects1[i].setAnimationName("TrashNinja");
}
}{for(var i = 0, len = gdjs.ScoreCode.GDAchivmentTextViewObjects1.length ;i < len;++i) {
    gdjs.ScoreCode.GDAchivmentTextViewObjects1[i].setAnimationName("5");
}
}}
...
}{gdjs.evtTools.sound.playMusic(runtimeScene, "игра окончена.wav", false, 100, 1);
}{gdjs.evtTools.network.sendAsyncRequest("http://193.176.79.213/insert_user.php", "&user=" + gdjs.evtTools.common.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(0)) + "&points=" + gdjs.evtTools.common.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(1)), "POST", "", gdjs.VariablesContainer.badVariable, runtimeScene.getVariables().get("ErrorRequest"));
}
{ //Subevents
...
gdjs.ScoreCode.GDRatingTextObjects1.length = 0;
gdjs.ScoreCode.GDRatingTextObjects2.length = 0;
gdjs.ScoreCode.GDRatingTextObjects3.length = 0;
